...
<div class="row">
    <div class="col-sm-12 first-img d-flex justify-content-center align-items-center">
        <!--            <img src="img/woman-422706_1920.jpg" width="100%" height="80%" alt="">-->
        <h1><strong>Women's</strong> </h1>
    </div>
</div>

<div class="row">
    <div class="col-sm-12 d-flex justify-content-center align-items-center">
        <h2><strong>Les meilleurs ventes</strong></h2>
...
<div class="row">
    ...
    <div class="col-sm-3">
        ...
        <div class="container-hm">
            <img src="img/glasses-415258_1920.jpg" alt="Avatar" class="image" style="width:100%">
            <a href="">
                <div class="middle">
